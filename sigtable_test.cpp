...
int main() {
  ...
  SigTable test_sigtable = SigTable(g_key1, g_key2, g_key3, g_table, (SLOTS*3)/2, SLOTS, g_stash, STASH_SIZE, g_hash_a, g_hash_b, HASH_FUNCS, g_top, g_stashTop, g_rebuild);
